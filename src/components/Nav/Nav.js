...
import NikeImage from "../../images/olive-tree.png";
...
function Nav() {
  ...
  return (
    <div>
      <h1 className="nike-shoes">Ruakokoputuna Olives</h1>
        ...
        <nav>
          <h2>
            {/* <img
              ...
              alt="Olive Logo"
            /> */}
            <img alt="Mona Lisa" src={NikeImage} title="saturate" className="saturate"/>
            ...
            <Link className={aboutState} to="/contact" onClick={setAbout}>
              {" "}
              Contact{" "}
            </Link>
